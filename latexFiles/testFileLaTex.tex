...
\item The system or a high level user must be able to select a cetain group based on specific information, to send a message to the recipient(s).
\end{itemize}
 \textbf{Post-Conditions: }
\begin{itemize}
...
\item 
\textbf{Scope}
The system must automatically change the status of a user based on his participation: the more a user participate, the more the user will be able to do.
\newline
\textbf{Limitations/exclusions:}
\item
...
\item The user must have a current status.
\end{itemize}
 \textbf{Post-Conditions: }
\begin{itemize}
...
\item 
\textbf{Scope}
The system must be able to integrate seamlessly with any specified host site.
\newline
\textbf{Limitations/exclusions:}
\item
...
\textbf{Pre-Conditions: }
\begin{itemize}
\item The host site must support the BuzzSpace systems technologies.
\item The BuzzSpace system must support the host sites technologies.
\item The host site must have enough space available for the BuzzSpace.
\end{itemize}
 \textbf{Post-Conditions: }
\begin{itemize}
\item The buzzSpace must be created.
\item The database of the BuzzSpace must be updated with the data on the host site.
\item 
\end{itemize}
\end{enumerate}
