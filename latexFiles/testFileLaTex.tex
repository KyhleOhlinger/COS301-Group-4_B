...
\begin{itemize}
	...
	\item\textbf{Exclusions:} Only users that are logged in to the system and have the privilege rights to evaluate/vote on posts will be allowed to evaluate/vote on posts. Higher Privileged users' votes will push posts higher (or lower) than lower privileged users. 
 	\item \textbf{Importance: } Important \newline \newline
...
\item\textbf{Limitations/exclusions:} 
