...
\item 	\textbf{Use case/Service Contracts: }
		\begin{itemize}
			...
			\begin{itemize}
	  		...
	  		\begin{center}
	  			\includegraphics[scale=0.5,left]{InputOutput.jpg}
	  		\end{center}
	  	\end{itemize}
\item	\textbf{Required Functionality}
	  		\begin{center}
	  			\includegraphics[scale=0.40,left]{UseCase.jpg}
	  		\end{center}
	  		\newpage
\item \textbf{Process Specifications}
	  		\begin{center}
	  			\includegraphics[scale=0.40,left]{Activity.jpg}
	  		\end{center}
\end{enumerate}
...
\item 	\textbf{Use case/Service Contracts: }
		\begin{itemize}
			...
			\begin{itemize}
	  		...
	  		\item	\textbf{Request and Results Data Structures}
	  		\begin{center}
	  			\includegraphics[scale=0.35,left]{NetInputOutput.jpg}
	  		\end{center}
	  	\end{itemize}
	  	\newpage
\item	\textbf{Required Functionality}
	  		\begin{center}
	  			\includegraphics[scale=0.35,left]{NetUseCase.jpg}
	  		\end{center}
	  		\newpage
\item \textbf{Process Specifications}
	  		\begin{center}
	  			\includegraphics[scale=0.40,left]{NetProcessDiagram.jpg}
	  		\end{center}
\end{enumerate}
