...
\begin{figure}[H]
	...
	\end{center}		
    	\caption{Message Tracking Class diagram}
	\end{figure}
...
The message length should be restricted. Content type should also be restricted based on level and status of the user posting the message.
...
\begin{itemize}	
	 ...
	 \graphicspath{ {../Diagrams/Andrew/} }
			...
			\begin{figure}[H]	
				\includegraphics[scale=0.5,center]{B1Activity.png}
...
\begin{itemize}	
 ...
 \graphicspath{ {../Diagrams/Andrew/} }
	...
	\end{figure}
	\begin{figure}[H]		
		\includegraphics[scale=0.5,center]{B2Activity.png}
...
\item Semi-automatic creation of thread summaries.
\begin{itemize}	
 ...
 \graphicspath{ {../Diagrams/Andrew/} }
		...
		\begin{figure}[H]	
			\includegraphics[scale=0.5,center]{B3UseCase.png}
			\caption{Semi-automatic Summaries Use Case Diagram}
		\end{figure}
			 	  		
		\begin{figure}[H]	
			\includegraphics[scale=0.5,center]{B3Activity.png}
...
\begin{figure}[H]	
\graphicspath{ {../Diagrams/sfiso/} }
    	\includegraphics[scale=0.5,center]{socialA.jpg}
...
\begin{figure}[H]	
\graphicspath{ {../Diagrams/sfiso/} }
    	\includegraphics[scale=0.5,center]{read.jpg}
    	\caption{Read Later Section Use Case Diagram}
	\end{figure}
	
	\begin{figure}[H]	
\graphicspath{ {../Diagrams/sfiso/} }
    	\includegraphics[scale=0.5,center]{readA.jpg}
...
\begin{itemize}
\item \textbf{Purpose:}
This deals with buzz space tagging for lowest level users, this will help social tagging by providing trending buzz space and
...
\graphicspath{ {../Diagrams/sfiso/} }
	...
	\begin{figure}[H]	
\graphicspath{ {../Diagrams/sfiso/} }
    	\includegraphics[scale=0.5,center]{tag.jpg}
...
\begin{figure}[H]	
\graphicspath{ {../Diagrams/sfiso/} }
    	\includegraphics[scale=0.5,center]{buzzA.jpg}
...
\graphicspath{ {../Diagrams/Maret/usecase/} }	
	\begin{figure}[H]	
    	\includegraphics[scale=0.5,center]{TemplateMessage.png}
...
\begin{itemize}
\item \textbf{Purpose: }The system must automatically change the status of a user based on his participation. The system award points to the user based on his actions, these points are then added and influence the users level. The user may lose points for "bad behaviour" and may win points for participation.
 
\item  \textbf{Limitation: } The status may only change after an action is performed.
...
\item\textbf{Pre-Conditions: }
	\begin{itemize}
		\item The host site must support the technologies of the Buzz system.
		\item The Buzz system must support the technologies of the host site.
...
\begin{itemize}
	...
	\item \textbf{Limitation: } Users will be limited to four filter categories, namely: topic, date posted/last updated, Buzz space name and rating.
	\item \textbf{Importance: } Important
...
%\item \textbf{Use case/Service Contracts: } \newline \newline
  \end{itemize}
	...
	\graphicspath{ {../Diagrams/Sphe/Search&Filter/} }
		\begin{figure}[H]	
    			\includegraphics[scale=0.5,center]{ActivityDiagram.jpg}
...
\begin{itemize}
	...
	\item\textbf{Limitations:} Only users that are logged in to the system and have the privilege rights to evaluate/vote on posts will be allowed to evaluate/vote on posts. Higher Privileged users' votes will push posts higher (or lower) than lower privileged users. 
 	\item \textbf{Importance: } Important
%	  \item \textbf{Use Case/Service Contract: } \newline \newline
	\item\textbf{Pre-Conditions}
	  	\begin{itemize}
	  		\item The user privilege level allows user to vote for post.
			\item The post must exist and not be removed.
		\end{itemize}
	\item\textbf{Post Conditions}
		\begin{itemize}
 ...
 \end{itemize}
	...
	\begin{figure}[H]	
    		\includegraphics[scale=0.5,center]{ClassDiagram.jpg}
...
\graphicspath{ {../Diagrams/Matt/Activity/} }
	  \begin{figure}[H]	
    	\includegraphics[scale=0.5,center]{Statisticalinformation.jpg}
    	\caption{Statistical Information Activity Diagram}
	\end{figure}

\graphicspath{ {../Diagrams/Matt/Case/} }
	  \begin{figure}[H]	
    	\includegraphics[scale=0.5,center]{StatisticalinformationCase.jpg}
...
\item Post mark up
\begin{itemize}
\item\textbf{Purpose:}Improved post editor for example text formatting and automatic pretty printing of code in posts.
\item\textbf{Limitations:} 
...
\graphicspath{ {../Diagrams/Matt/Case/} }
	  \begin{figure}[H]	
    	\includegraphics[scale=0.5,center]{Postmarkupcase.jpg}
	...
	%	\newline
		...
		\item	\textbf{Post-Conditions}
		  	...
		  	\newpage
				...
				\end{figure}
				\begin{figure}[H]
    					\includegraphics[scale=0.4,center]{Activity.jpg}
